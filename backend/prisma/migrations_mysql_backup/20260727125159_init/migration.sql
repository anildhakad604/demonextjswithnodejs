...
CREATE TABLE `StockMovement` (
    ...
    INDEX `StockMovement_productSizeId_idx`(`productSizeId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `Order` (
    ...
    INDEX `Order_razorpayOrderId_idx`(`razorpayOrderId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `StockMovement` ADD CONSTRAINT `StockMovement_productSizeId_fkey` FOREIGN KEY (`productSizeId`) REFERENCES `ProductSize`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
